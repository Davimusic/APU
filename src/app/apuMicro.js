...
export function ApuMicro(){
    ...
    //redux
    const reduxInfo = useSelector(state => state.objetoMatematico);
    ...
    async function fetchInfo(nomObj) {
        ...
        dispatch(updateInfo(result.objeto['objetos']))// prueba
    ...
    let inf = [...reduxInfo] // Crea una copia del array info
